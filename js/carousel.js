...
function Carousel(crslId) {
    ...
    this.options = Carousel.defaults;
...
Carousel.prototype.elemNext = function(num) {
	num = num || 1;
...
Carousel.prototype.dotOn = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#BBB; cursor:pointer;'
};

Carousel.prototype.dotOff = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#556; cursor:default;'
};

Carousel.initialize = function(that) {
